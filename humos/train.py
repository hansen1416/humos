...
def train(hparams):
    ...
    train_dataset = get_text_motion_dataset(hparams, split="train")
    ...
    # TODO: Remove this. Reinitialization needed because otherwise the fit step fails if called after validate in pytorch_lightning
    # model = initialize_model(hparams, ckpt, renderer=ait_renderer)
